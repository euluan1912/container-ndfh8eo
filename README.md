...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-ndfh8eo.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-ndfh8eo.containers.anotherwebservice.com/
...
```
git clone git@github.com:euluan1912/container-ndfh8eo.git
cd container-ndfh8eo
```
...
```
docker attach container-ndfh8eo
```
